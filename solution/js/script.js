...
const shadowHeader = () => {
  ...
  // Add a class if the scroll offset is greater than 50 of the viewport height
  window.scrollY >= 50
...
const cartButtons = document.querySelectorAll(".popular__button");

function checkCart() {
  alert("Sorry we're currently out of business.");
}

cartButtons.forEach((button) => {
  button.addEventListener("click", (e) => {
    e.preventDefault();
    setTimeout(checkCart, 100); // Adds a small delay for better UX
  });
});
